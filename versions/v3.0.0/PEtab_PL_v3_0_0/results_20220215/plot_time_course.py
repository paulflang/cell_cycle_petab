...
out_file = os.path.join(file_dir, 'optimisation_ground_truth')
...
yaml_config_opt = os.path.join(file_dir, '..', 'v3.0.0.yaml')
...
# Simulation
petab_problem = petab.Problem.from_yaml(yaml_config_opt)
