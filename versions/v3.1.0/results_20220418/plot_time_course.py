...
out_file = os.path.join(file_dir, 'optimization')
...
yaml_config = os.path.join(file_dir, 'v3.1.0_plot.yaml')
yaml_config_opt = os.path.join(file_dir, '..', 'v3.1.0.yaml')
...
# Simulation
petab_problem = petab.Problem.from_yaml(yaml_config)  # yaml_config_opt)
