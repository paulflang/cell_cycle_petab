...
image_file = 'v3.2.0_manu' # 'corr_n300_std0.8_vars9.png'
...
fig, axs = plt.subplots(3,2, figsize=(textwidth, 1.5*textwidth/1.33))
((a, b), (cc, d), (e, f)) = axs
fig.subplots_adjust(left=0.08, right=0.99, bottom=0.1/1.5, hspace=0.7, wspace=0.4)
...
cc.legend(handles=handles, frameon=True, fontsize=8, loc='lower left', bbox_to_anchor=(0.05, -1.9)) # lower right 1.025, -1.75
