...
image_file = 'v4.0.0c' # 'corr_n300_std0.8_vars9.png'
...
legend_labels1 = ['CCNE$_{cyt}$', 'CCNA$_{cyt}$', 'CCNB1$_{cyt}$']
legend_labels2 = ['E2F1$_{cyt}$', 'RB1(Ser807_Ser811~p)$_{cyt}$', 'SKP2$_{cyt}$']
legend_labels3 = ['CDKN1A$_{cyt}$', 'CDKN1B$_{cyt}$']

variables1 = ['obs_cycE__cyt_median', 'obs_cycA__cyt_median', 'obs_cycB1__cyt_median']
variables2 = ['obs_E2F1__cyt_median', 'obs_pRB__cyt_median', 'obs_Skp2__cyt_median']
variables3 = ['obs_p21__cyt_median', 'obs_p27__cyt_median']
