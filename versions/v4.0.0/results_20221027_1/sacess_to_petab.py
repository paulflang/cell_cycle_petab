...
version = 'v4.0.0'
date = '20221027_1'
sacess_fn = os.path.join(base_dir, 'PEtab_PLang_problem_v35.xlsx')
parameter_table_fn = os.path.join(base_dir, version, f'parameters_{version}_v9.tsv')
