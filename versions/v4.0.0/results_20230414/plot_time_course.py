...
# run any simulation, this will set simulator.amici_model
optimized_data_df = simulator.simulate()
solver = simulator.amici_model.getSolver()
solver.setMaxSteps(100*solver.getMaxSteps())
optimized_data_df = simulator.simulate(..., solver=solver)
